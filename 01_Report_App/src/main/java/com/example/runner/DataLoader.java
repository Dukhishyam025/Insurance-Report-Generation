...
//This class is for inserting data into database
...
public class DataLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		c5.setDenialReason("Porperty Income");
		...
		c8.setCitizenName("Willam");
		c8.setGender("Male");
		c8.setPlanName("Medical");
		c8.setPlanStatus("Denied");
		c8.setDenialReason("Porperty Income");
		...
		c11.setDenialReason("Porperty Income");

		CitizenPlan c12 = new CitizenPlan();
		c12.setCitizenName("Anjali");
